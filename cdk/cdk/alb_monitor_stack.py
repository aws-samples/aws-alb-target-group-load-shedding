...
class ALBMonitorStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Main queue with DLQ and encryption
        queue = sqs.Queue(
            scope=self, 
            id='alb_target_group_monitor_queue',
        ...
        # Least-privilege ELB policy (generated by IAM Policy Autopilot)
        inline_policy_json_elb = {
            'Version': '2012-10-17',
            'Statement': [
                {
                    "Effect": "Allow",
            ...
            'Statement': [
                {
                    ...
                    "Resource": f"arn:aws:logs:{self.region}:{self.account}:log-group:/aws/lambda/*"
                }
            ]
        }
        ...
        alarm_lambda_execution_role = iam.Role(
            ...
            inline_policies={
                "elb": iam.PolicyDocument.from_json(inline_policy_json_elb),
                "cloudwatch": iam.PolicyDocument.from_json(inline_policy_json_cloudwatch),
        ...
        self.alb_alarm_lambda = lambda_.Function(
            ...
            description='Lambda Handler for ALB Alarms',
        ...
        dlq_alarm = cloudwatch.Alarm(
            self,
            'DLQMessagesAlarm',
            alarm_name='ALBMonitorDLQMessages',
